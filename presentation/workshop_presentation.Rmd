...
3. Sequences PCR products of each sample with Illumina
...
* **dada2**: An R package. Fast and statistically-sound.
...
* Unique sequences: Every unique sequence is treated as a different "organism"
...
* The commonly used measures Richness, Shannon, Simpson are all transformations of the more general "Hill numbers".
...
* If Levene tests for homogeneity of variance and Shapiro-Wilk tests for normality pass:
...
Bioinformatic analysis techniques for exploring comparing communities.
...
**Unifrac** is the proportion of branch length of a phylogenetic tree the is shared by two communities.
