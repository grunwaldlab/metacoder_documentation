...
The `metacoder` package supplies generic parsers that can read almost any format of taxonomic data, but they often require some understanding of regular expressions.
...
This page shows examples for how to parse specific formats, using either the dedicated `metacoder` functions or the more general `metacoder` functions.
