...
We wrote and actively maintain `metacoder` [@foster2017metacoder] so it is heavily relied upon in this primer.
...
If the installation does not work, try installing the packages one at a time (e.g., `install.packages("vegan")`) and look for error messages.
...
If you are in a workshop with no internet conection [click here](appendix--00--no_internet_install.html) for how to install software offline.
