...
What if there are sequences assigned to that taxon; are the sequences removed or reassigned to a preserved supertaxon?
...
For each `dplyr` verb, there are two functions in metacodeRr, one that manipulates the taxon portion of the data and one that manipulates the observation portion.
...
Subsetting columns is more straight forward than subsetting rows.
