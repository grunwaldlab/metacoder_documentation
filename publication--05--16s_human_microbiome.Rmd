...
matrix_data <- calc_subplot_coords(layout_matrix, x1 = 0, y1 = 0, x2 = 0.9, y2 = 0.9)
...
horz_label_data$label_y <- 0.9 # bottom of label
vert_label_data$label_x <- 0.9 # bottom of rotated label 
