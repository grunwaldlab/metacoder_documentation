...
```{r}
plot_sample_tree <- function(data, sample, out_name, min_count = 1, ...) {
  data %>%
    ...
    heat_tree(
      ...
      node_size = sample, 
      node_color = sample, 
      # node_color_range = viridis::plasma(10),
      ...
      output_file = file.path(output_folder, paste0(out_name, output_format)))
}
