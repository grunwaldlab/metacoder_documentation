...
It might be made into a more generic "table parser" in the future.
...
Therefore, rare taxa are exculded from the graph or only coarse taxonomic ranks are displayed. 
...
ggsave(result_path("bubble_plot"), width = 5, height = 4)
print(bubble_plot)
```
