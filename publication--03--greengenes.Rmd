...
Although graphing everything can be a bit overwhelming (`r nrow(greengenes$taxon_data)` taxa), it gives an intuitive feel for the complexity of the database:
